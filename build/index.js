...
var _nodePolyglot = __webpack_require__(18);
...
var PolyglotProvider = function (_Component) {
  _inherits(PolyglotProvider, _Component);

  function PolyglotProvider(props) {
    _classCallCheck(this, PolyglotProvider);

    var _this = _possibleConstructorReturn(this, (PolyglotProvider.__proto__ || Object.getPrototypeOf(PolyglotProvider)).call(this, props));

    _this.polyglot = new _nodePolyglot2.default({
      locale: props.locale,
      phrases: props.wordings[props.locale]
    });
    _this.state = {
      t: _this.polyglot.t.bind(_this.polyglot)
    };
    return _this;
  }

  _createClass(PolyglotProvider, [{
...
PolyglotProvider.propTypes = {
  ...
  wordings: _propTypes2.default.object.isRequired,
  render: _propTypes2.default.func.isRequired
};

exports.default = PolyglotProvider;
